...
/* harmony import */ var _helper_fns__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./helper-fns */ "./src/helper-fns.js");
...
(() => {
  ...
  const updateRealtimeDOM = () => {
    ...
    conditionElem.innerText = (0,_helper_fns__WEBPACK_IMPORTED_MODULE_2__.titleCase)(results.weather.condition.text);

    const iconCode = results.weather.condition.icon;
    const bgImageFile = (0,_helper_fns__WEBPACK_IMPORTED_MODULE_2__.getBgImage)(results.weather.condition.icon);
  ...
  const handleSearch = async (location) => {
    ...
    const useAPI = false;
    if (useAPI) {
      results = await (0,_weather__WEBPACK_IMPORTED_MODULE_3__["default"])(location);

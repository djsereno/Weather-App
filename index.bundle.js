...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ":root {\n  --fs-xl: 7rem;\n  --fs-600: 2rem;\n  --fs-500: 1.5em;\n  --fs-400: 1.125rem;\n  --fs-300: 0.8rem;\n\n  --clr-primary: white;\n  --blur-intensity: 0px;\n}\n\n@media (max-width: 1200px) {\n  :root {\n    --fs-xl: 5.5rem;\n    --fs-600: 1.75rem;\n    --fs-500: 1.375rem;\n  }\n}\n\n@media (max-width: 1000px) {\n  :root {\n    --fs-xl: 4rem;\n    --fs-600: 1.25rem;\n    --fs-500: 1.125rem;\n  }\n}\n\n*,\n*::before,\n*::after {\n  margin: 0;\n  padding: 0;\n  box-sizing: border-box;\n}\n\nbody {\n  font-family: 'Roboto', system-ui;\n  font-size: var(--fs-400);\n  color: white;\n  line-height: 1.5;\n}\n\nmain {\n  width: min(1200px, 100% - 4rem);\n  margin-top: 5rem;\n  margin-bottom: 5rem;\n  margin-inline: auto;\n}\n\n.bg {\n  position: fixed;\n  left: 0;\n  top: 0;\n  z-index: -1;\n  width: 100%;\n  height: 100%;\n  background: rgb(99, 174, 244);\n  background: linear-gradient(180deg, rgba(99, 174, 244, 1) 0%, rgba(44, 95, 143, 1) 100%);\n}\n\n.bg img {\n  position: absolute;\n  left: calc(-2 * var(--blur-intensity));\n  right: 0;\n  top: calc(-2 * var(--blur-intensity));\n  bottom: 0;\n  width: calc(100% + 4 * var(--blur-intensity));\n  height: calc(100% + 4 * var(--blur-intensity));\n  object-fit: cover;\n  filter: blur(var(--blur-intensity)) brightness(80%);\n}\n\n.card {\n  max-width: 100%;\n  padding: 1rem;\n  border-radius: 5px;\n  background-color: rgba(0, 0, 0, 0.4);\n  box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px;\n}\n\n.hidden {\n  display: none;\n  opacity: 0;\n}\n\n.flex-row {\n  display: flex;\n}\n\n.flex-col {\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n}\n\n#current-weather {\n  display: grid;\n  grid-template-columns: 1fr 0.8fr 1fr;\n  justify-items: center;\n  font-size: var(--fs-500);\n  gap: 3rem;\n  padding: 3rem;\n}\n\n#main {\n  display: grid;\n  grid-template-rows: auto auto auto 1fr;\n  align-items: center;\n}\n\n#location {\n  display: grid;\n  grid-template-columns: auto auto 1em;\n  gap: 10px;\n}\n\n.spinner-group {\n  position: relative;\n}\n\n.loc-pin {\n  visibility: hidden;\n}\n.loc-pin.visible {\n  visibility: visible;\n}\n\n.spinner {\n  display: block;\n  position: absolute;\n  left: 50%;\n  top: 50%;\n  transform-origin: center;\n  animation-duration: 0.7s;\n  animation-name: spinner;\n  animation-iteration-count: infinite;\n  animation-timing-function: steps(8, end);\n}\n\n@keyframes spinner {\n  from {\n    transform: translate(-50%, -50%) rotate(0deg);\n  }\n  to {\n    transform: translate(-50%, -50%) rotate(360deg);\n  }\n}\n\n#loc,\n#search {\n  font-weight: bold;\n  background: transparent;\n  border: none;\n  color: var(--clr-primary);\n}\n\n#loc:focus-visible,\n#search:focus-visible {\n  outline: 2px solid var(--clr-primary);\n  outline-offset: 3px;\n  border-radius: 3px;\n}\n\n#loc {\n  text-overflow: ellipsis;\n  width: 100%;\n}\n\n#loc:hover:not(:focus) {\n  text-decoration: underline;\n}\n\n#loc::placeholder {\n  color: var(--clr-primary);\n  font-weight: 300;\n  opacity: 0.4;\n}\n\n#search {\n  visibility: hidden;\n  font-size: 0.1em;\n  transition: font-size 0.3s 0s, visibility 0s 0.3s;\n}\n#search.visible {\n  transition: visibility 0s, font-size 0.3s;\n  visibility: visible;\n  font-size: 0.9em;\n}\n\n#date,\n#time-group,\n#details {\n  font-weight: 300;\n}\n\n#temp-group {\n  font-size: var(--fs-xl);\n}\n\n.unit-toggle-group {\n  font-size: var(--fs-400);\n  color: var(--clr-primary);\n  opacity: 0.4;\n}\n\nbutton.unit-toggle {\n  border: none;\n  background-color: transparent;\n  color: var(--clr-primary);\n}\n\nbutton.unit-toggle:hover {\n  text-decoration: underline;\n}\n\nbutton:hover {\n  cursor: pointer;\n}\n\n#current-condition {\n  width: 100%;\n  font-size: var(--fs-600);\n  font-weight: 300;\n  font-weight: bold;\n  text-align: center;\n}\n\n#condition-icon {\n  width: 100%;\n}\n\n#details {\n  line-height: 1.8;\n}\n\n.detail-group > i:first-child {\n  width: 3ch;\n}\n\n.detail-group > #wind_dir {\n  margin-right: 1ch;\n}\n\n#forecast {\n  display: grid;\n  grid-template-columns: repeat(auto-fit, minmax(140px, 1fr));\n  margin-top: 10px;\n  gap: 10px;\n}\n\n#forecast .card {\n  align-items: center;\n  justify-content: start;\n  text-align: center;\n  gap: 5px;\n}\n\n.day {\n  font-weight: 300;\n}\n\n.forecast-icon {\n  width: min(200px, 100%);\n}\n\n.high-low {\n  display: flex;\n  gap: 1ch;\n}\n\n.high-temp {\n  font-weight: 500;\n}\n\n.low-temp {\n  font-weight: 300;\n  opacity: 0.6;\n}\n\n.precipitation {\n  font-size: var(--fs-300);\n  opacity: 0.6;\n}\n\n@media (max-width: 800px) {\n  main {\n    margin-top: 2rem;\n    margin-bottom: 2rem;\n  }\n  #current-weather {\n    grid-template-columns: 1fr 1fr;\n    grid-template-rows: 1fr 1fr;\n  }\n  #current-condition {\n    grid-column: 2 / 3;\n    grid-row: 1 / 3;\n    align-self: center;\n  }\n  #details {\n    justify-self: start;\n  }\n}\n\n@media (max-width: 600px) {\n  #main {\n    justify-self: center;\n    text-align: center;\n  }\n  #loc {\n    text-align: center;\n  }\n  #current-weather {\n    grid-template-columns: 1fr;\n    grid-template-rows: repeat(3, min-content);\n    gap: 0rem;\n    padding: 1.5rem;\n  }\n  #current-condition {\n    grid-column: auto;\n    grid-row: auto;\n    align-self: center;\n    max-height: 250px;\n  }\n  #condition-icon {\n    height: 200px;\n    width: auto;\n  }\n  #details {\n    padding-top: 2rem;\n    justify-self: center;\n  }\n}\n", "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAEA;EACE,aAAa;EACb,cAAc;EACd,eAAe;EACf,kBAAkB;EAClB,gBAAgB;;EAEhB,oBAAoB;EACpB,qBAAqB;AACvB;;AAEA;EACE;IACE,eAAe;IACf,iBAAiB;IACjB,kBAAkB;EACpB;AACF;;AAEA;EACE;IACE,aAAa;IACb,iBAAiB;IACjB,kBAAkB;EACpB;AACF;;AAEA;;;EAGE,SAAS;EACT,UAAU;EACV,sBAAsB;AACxB;;AAEA;EACE,gCAAgC;EAChC,wBAAwB;EACxB,YAAY;EACZ,gBAAgB;AAClB;;AAEA;EACE,+BAA+B;EAC/B,gBAAgB;EAChB,mBAAmB;EACnB,mBAAmB;AACrB;;AAEA;EACE,eAAe;EACf,OAAO;EACP,MAAM;EACN,WAAW;EACX,WAAW;EACX,YAAY;EACZ,6BAA6B;EAC7B,wFAAwF;AAC1F;;AAEA;EACE,kBAAkB;EAClB,sCAAsC;EACtC,QAAQ;EACR,qCAAqC;EACrC,SAAS;EACT,6CAA6C;EAC7C,8CAA8C;EAC9C,iBAAiB;EACjB,mDAAmD;AACrD;;AAEA;EACE,eAAe;EACf,aAAa;EACb,kBAAkB;EAClB,oCAAoC;EACpC,4CAA4C;AAC9C;;AAEA;EACE,aAAa;EACb,UAAU;AACZ;;AAEA;EACE,aAAa;AACf;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,uBAAuB;AACzB;;AAEA;EACE,aAAa;EACb,oCAAoC;EACpC,qBAAqB;EACrB,wBAAwB;EACxB,SAAS;EACT,aAAa;AACf;;AAEA;EACE,aAAa;EACb,sCAAsC;EACtC,mBAAmB;AACrB;;AAEA;EACE,aAAa;EACb,oCAAoC;EACpC,SAAS;AACX;;AAEA;EACE,kBAAkB;AACpB;;AAEA;EACE,kBAAkB;AACpB;AACA;EACE,mBAAmB;AACrB;;AAEA;EACE,cAAc;EACd,kBAAkB;EAClB,SAAS;EACT,QAAQ;EACR,wBAAwB;EACxB,wBAAwB;EACxB,uBAAuB;EACvB,mCAAmC;EACnC,wCAAwC;AAC1C;;AAEA;EACE;IACE,6CAA6C;EAC/C;EACA;IACE,+CAA+C;EACjD;AACF;;AAEA;;EAEE,iBAAiB;EACjB,uBAAuB;EACvB,YAAY;EACZ,yBAAyB;AAC3B;;AAEA;;EAEE,qCAAqC;EACrC,mBAAmB;EACnB,kBAAkB;AACpB;;AAEA;EACE,uBAAuB;EACvB,WAAW;AACb;;AAEA;EACE,0BAA0B;AAC5B;;AAEA;EACE,yBAAyB;EACzB,gBAAgB;EAChB,YAAY;AACd;;AAEA;EACE,kBAAkB;EAClB,gBAAgB;EAChB,iDAAiD;AACnD;AACA;EACE,yCAAyC;EACzC,mBAAmB;EACnB,gBAAgB;AAClB;;AAEA;;;EAGE,gBAAgB;AAClB;;AAEA;EACE,uBAAuB;AACzB;;AAEA;EACE,wBAAwB;EACxB,yBAAyB;EACzB,YAAY;AACd;;AAEA;EACE,YAAY;EACZ,6BAA6B;EAC7B,yBAAyB;AAC3B;;AAEA;EACE,0BAA0B;AAC5B;;AAEA;EACE,eAAe;AACjB;;AAEA;EACE,WAAW;EACX,wBAAwB;EACxB,gBAAgB;EAChB,iBAAiB;EACjB,kBAAkB;AACpB;;AAEA;EACE,WAAW;AACb;;AAEA;EACE,gBAAgB;AAClB;;AAEA;EACE,UAAU;AACZ;;AAEA;EACE,iBAAiB;AACnB;;AAEA;EACE,aAAa;EACb,2DAA2D;EAC3D,gBAAgB;EAChB,SAAS;AACX;;AAEA;EACE,mBAAmB;EACnB,sBAAsB;EACtB,kBAAkB;EAClB,QAAQ;AACV;;AAEA;EACE,gBAAgB;AAClB;;AAEA;EACE,uBAAuB;AACzB;;AAEA;EACE,aAAa;EACb,QAAQ;AACV;;AAEA;EACE,gBAAgB;AAClB;;AAEA;EACE,gBAAgB;EAChB,YAAY;AACd;;AAEA;EACE,wBAAwB;EACxB,YAAY;AACd;;AAEA;EACE;IACE,gBAAgB;IAChB,mBAAmB;EACrB;EACA;IACE,8BAA8B;IAC9B,2BAA2B;EAC7B;EACA;IACE,kBAAkB;IAClB,eAAe;IACf,kBAAkB;EACpB;EACA;IACE,mBAAmB;EACrB;AACF;;AAEA;EACE;IACE,oBAAoB;IACpB,kBAAkB;EACpB;EACA;IACE,kBAAkB;EACpB;EACA;IACE,0BAA0B;IAC1B,0CAA0C;IAC1C,SAAS;IACT,eAAe;EACjB;EACA;IACE,iBAAiB;IACjB,cAAc;IACd,kBAAkB;IAClB,iBAAiB;EACnB;EACA;IACE,aAAa;IACb,WAAW;EACb;EACA;IACE,iBAAiB;IACjB,oBAAoB;EACtB;AACF","sourcesContent":["@import url('https://fonts.googleapis.com/css2?family=Roboto:ital,wght@0,100;0,300;0,400;0,500;0,700;0,900;1,100;1,300;1,400;1,500;1,700;1,900&display=swap');\n\n:root {\n  --fs-xl: 7rem;\n  --fs-600: 2rem;\n  --fs-500: 1.5em;\n  --fs-400: 1.125rem;\n  --fs-300: 0.8rem;\n\n  --clr-primary: white;\n  --blur-intensity: 0px;\n}\n\n@media (max-width: 1200px) {\n  :root {\n    --fs-xl: 5.5rem;\n    --fs-600: 1.75rem;\n    --fs-500: 1.375rem;\n  }\n}\n\n@media (max-width: 1000px) {\n  :root {\n    --fs-xl: 4rem;\n    --fs-600: 1.25rem;\n    --fs-500: 1.125rem;\n  }\n}\n\n*,\n*::before,\n*::after {\n  margin: 0;\n  padding: 0;\n  box-sizing: border-box;\n}\n\nbody {\n  font-family: 'Roboto', system-ui;\n  font-size: var(--fs-400);\n  color: white;\n  line-height: 1.5;\n}\n\nmain {\n  width: min(1200px, 100% - 4rem);\n  margin-top: 5rem;\n  margin-bottom: 5rem;\n  margin-inline: auto;\n}\n\n.bg {\n  position: fixed;\n  left: 0;\n  top: 0;\n  z-index: -1;\n  width: 100%;\n  height: 100%;\n  background: rgb(99, 174, 244);\n  background: linear-gradient(180deg, rgba(99, 174, 244, 1) 0%, rgba(44, 95, 143, 1) 100%);\n}\n\n.bg img {\n  position: absolute;\n  left: calc(-2 * var(--blur-intensity));\n  right: 0;\n  top: calc(-2 * var(--blur-intensity));\n  bottom: 0;\n  width: calc(100% + 4 * var(--blur-intensity));\n  height: calc(100% + 4 * var(--blur-intensity));\n  object-fit: cover;\n  filter: blur(var(--blur-intensity)) brightness(80%);\n}\n\n.card {\n  max-width: 100%;\n  padding: 1rem;\n  border-radius: 5px;\n  background-color: rgba(0, 0, 0, 0.4);\n  box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px;\n}\n\n.hidden {\n  display: none;\n  opacity: 0;\n}\n\n.flex-row {\n  display: flex;\n}\n\n.flex-col {\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n}\n\n#current-weather {\n  display: grid;\n  grid-template-columns: 1fr 0.8fr 1fr;\n  justify-items: center;\n  font-size: var(--fs-500);\n  gap: 3rem;\n  padding: 3rem;\n}\n\n#main {\n  display: grid;\n  grid-template-rows: auto auto auto 1fr;\n  align-items: center;\n}\n\n#location {\n  display: grid;\n  grid-template-columns: auto auto 1em;\n  gap: 10px;\n}\n\n.spinner-group {\n  position: relative;\n}\n\n.loc-pin {\n  visibility: hidden;\n}\n.loc-pin.visible {\n  visibility: visible;\n}\n\n.spinner {\n  display: block;\n  position: absolute;\n  left: 50%;\n  top: 50%;\n  transform-origin: center;\n  animation-duration: 0.7s;\n  animation-name: spinner;\n  animation-iteration-count: infinite;\n  animation-timing-function: steps(8, end);\n}\n\n@keyframes spinner {\n  from {\n    transform: translate(-50%, -50%) rotate(0deg);\n  }\n  to {\n    transform: translate(-50%, -50%) rotate(360deg);\n  }\n}\n\n#loc,\n#search {\n  font-weight: bold;\n  background: transparent;\n  border: none;\n  color: var(--clr-primary);\n}\n\n#loc:focus-visible,\n#search:focus-visible {\n  outline: 2px solid var(--clr-primary);\n  outline-offset: 3px;\n  border-radius: 3px;\n}\n\n#loc {\n  text-overflow: ellipsis;\n  width: 100%;\n}\n\n#loc:hover:not(:focus) {\n  text-decoration: underline;\n}\n\n#loc::placeholder {\n  color: var(--clr-primary);\n  font-weight: 300;\n  opacity: 0.4;\n}\n\n#search {\n  visibility: hidden;\n  font-size: 0.1em;\n  transition: font-size 0.3s 0s, visibility 0s 0.3s;\n}\n#search.visible {\n  transition: visibility 0s, font-size 0.3s;\n  visibility: visible;\n  font-size: 0.9em;\n}\n\n#date,\n#time-group,\n#details {\n  font-weight: 300;\n}\n\n#temp-group {\n  font-size: var(--fs-xl);\n}\n\n.unit-toggle-group {\n  font-size: var(--fs-400);\n  color: var(--clr-primary);\n  opacity: 0.4;\n}\n\nbutton.unit-toggle {\n  border: none;\n  background-color: transparent;\n  color: var(--clr-primary);\n}\n\nbutton.unit-toggle:hover {\n  text-decoration: underline;\n}\n\nbutton:hover {\n  cursor: pointer;\n}\n\n#current-condition {\n  width: 100%;\n  font-size: var(--fs-600);\n  font-weight: 300;\n  font-weight: bold;\n  text-align: center;\n}\n\n#condition-icon {\n  width: 100%;\n}\n\n#details {\n  line-height: 1.8;\n}\n\n.detail-group > i:first-child {\n  width: 3ch;\n}\n\n.detail-group > #wind_dir {\n  margin-right: 1ch;\n}\n\n#forecast {\n  display: grid;\n  grid-template-columns: repeat(auto-fit, minmax(140px, 1fr));\n  margin-top: 10px;\n  gap: 10px;\n}\n\n#forecast .card {\n  align-items: center;\n  justify-content: start;\n  text-align: center;\n  gap: 5px;\n}\n\n.day {\n  font-weight: 300;\n}\n\n.forecast-icon {\n  width: min(200px, 100%);\n}\n\n.high-low {\n  display: flex;\n  gap: 1ch;\n}\n\n.high-temp {\n  font-weight: 500;\n}\n\n.low-temp {\n  font-weight: 300;\n  opacity: 0.6;\n}\n\n.precipitation {\n  font-size: var(--fs-300);\n  opacity: 0.6;\n}\n\n@media (max-width: 800px) {\n  main {\n    margin-top: 2rem;\n    margin-bottom: 2rem;\n  }\n  #current-weather {\n    grid-template-columns: 1fr 1fr;\n    grid-template-rows: 1fr 1fr;\n  }\n  #current-condition {\n    grid-column: 2 / 3;\n    grid-row: 1 / 3;\n    align-self: center;\n  }\n  #details {\n    justify-self: start;\n  }\n}\n\n@media (max-width: 600px) {\n  #main {\n    justify-self: center;\n    text-align: center;\n  }\n  #loc {\n    text-align: center;\n  }\n  #current-weather {\n    grid-template-columns: 1fr;\n    grid-template-rows: repeat(3, min-content);\n    gap: 0rem;\n    padding: 1.5rem;\n  }\n  #current-condition {\n    grid-column: auto;\n    grid-row: auto;\n    align-self: center;\n    max-height: 250px;\n  }\n  #condition-icon {\n    height: 200px;\n    width: auto;\n  }\n  #details {\n    padding-top: 2rem;\n    justify-self: center;\n  }\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "getBgImage": () => (/* binding */ getBgImage),
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (getSampleData);
...
/* harmony import */ var _helper_fns__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./helper-fns */ "./src/helper-fns.js");
/* harmony import */ var _sampledata__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./sampledata */ "./src/sampledata.js");
...
(() => {
  ...
  const updateTimeElem = (timeFormat) => {
    if (timeFormat === 24) {
      timeElem.innerText = (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(date, 'kk:mm');
      return;
    }
    timeElem.innerText = (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(date, 'p');
  };
  ...
  const updateRealtimeDOM = () => {
    ...
    dateElem.innerText = (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(date, 'EEEE, MMMM do');
    updateTimeElem(12);

    tempImpElem.innerText = `${results.weather.temp.imp}°F`;
    tempMetElem.innerText = `${results.weather.temp.met}°C`;
    conditionElem.innerText = (0,_helper_fns__WEBPACK_IMPORTED_MODULE_3__.titleCase)(results.weather.condition.text);

    const iconCode = results.weather.condition.icon;
    const bgImageFile = (0,_helper_fns__WEBPACK_IMPORTED_MODULE_3__.getBgImage)(results.weather.condition.icon);
  ...
  const updateForecastDOM = () => {
    ...
    results.forecast.forEach((day) => {
      ...
      const forecastDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])(day.date, 'yyyy-MM-dd', new Date());
      const forecastWeather = day.weather;

      dayElem.innerText = (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(forecastDate, 'ccc d');
      if ((0,date_fns__WEBPACK_IMPORTED_MODULE_7__["default"])(forecastDate)) dayElem.innerText = 'Today';
      if ((0,date_fns__WEBPACK_IMPORTED_MODULE_8__["default"])(forecastDate)) dayElem.innerText = 'Tomorrow';
  ...
  const handleSearch = async (location) => {
    ...
    const useAPI = true;
    if (useAPI) {
      results = await (0,_weather__WEBPACK_IMPORTED_MODULE_2__["default"])(location);
      // console.log(JSON.stringify(results));
    } else {
      results = await (0,_sampledata__WEBPACK_IMPORTED_MODULE_4__["default"])();
    }

...
(() => {
  ...
  const handleSearch = async (location) => {
    ...
    useAPI ? (results = await (0,_weather__WEBPACK_IMPORTED_MODULE_3__["default"])(location)) : (results = await (0,_sampledata__WEBPACK_IMPORTED_MODULE_4__["default"])());
    toggleLoadingSpinner();
    updateRealtimeDOM();
    updateForecastDOM();
    setUnitFormat();

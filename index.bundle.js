...
(() => {
  ...
  const updateRealtimeDOM = () => {
    ...
    const bgImageFile = (0,_helper_fns__WEBPACK_IMPORTED_MODULE_2__.getBgImage)(weatherData.weather.condition.icon);
    const dayOrNight = weatherData.weather.is_day ? 'day' : 'night';
    conditionElem.innerText = (0,_helper_fns__WEBPACK_IMPORTED_MODULE_2__.titleCase)(weatherData.weather.condition.text);
  ...
  const handleSearch = async (location) => {
    ...
    const newWeatherData = useAPI ? await (0,_weather__WEBPACK_IMPORTED_MODULE_3__["default"])(location) : await (0,_sampledata__WEBPACK_IMPORTED_MODULE_4__["default"])();
    toggleLoadingSpinner();
